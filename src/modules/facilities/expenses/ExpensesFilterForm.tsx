...
let ExpenseFilterForm: React.FC<Props> = ({
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      if (axios.isCancel(error)) {
        console.log("ERROR DOWNLOADING EXPENSES: ", error.message);
      }
    }
  };
...
ExpenseFilterForm = React.memo(ExpenseFilterForm);
