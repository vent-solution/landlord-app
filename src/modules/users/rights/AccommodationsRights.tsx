...
let AccommodationsRights: React.FC<Props> = ({
  switchClickAction,
  setCurrentSection,
  viewRights,
}) => {
  return (
    ...
    >
      ...
      <section>
        ...
        >
          <SwitchButton element={viewRights["accommodations"]} />
        </div>
...
AccommodationsRights = React.memo(AccommodationsRights);

export default AccommodationsRights;
